...
intellij_idea_version=212.5457.46

# Download IntelliJ IDEA and Android plugin(required for building IntelliJ IDEA)

wget https://github.com/JetBrains/intellij-community/archive/refs/tags/idea/212.5457.46.tar.gz -O intellij-idea-source.tar.gz
git clone --depth 1 --branch idea/212.5457.46 git://git.jetbrains.org/idea/android.git
